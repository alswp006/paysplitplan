...
- validation.ts: export interface ValidationError; export function validateSetup(draft: PlanDraft): SetupErrors; export function validateSetupInput( salary: number, fixedCosts: Plan["fixedCos...
...
// src/components/FixedCostSheet.tsx
...
// src/components/IncomeScenarioSection.tsx
...
export function activeBuckets(buckets: Record<string, number>
