...
- validation.ts: export interface ValidationError; export function validateSetup(draft: PlanDraft): SetupErrors; export function validateSetupInput( salary: number, fixed...
...
// src/components/TrendSection.tsx
